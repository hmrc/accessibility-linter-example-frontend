...
import uk.gov.hmrc.accessibilitylinterexamplefrontend.views.html.HelloUniversePage
import uk.gov.hmrc.scalatestaccessibilitylinter.AccessibilityMatchers

class HelloUniversePageSpec extends AnyWordSpec with Matchers with GuiceOneAppPerSuite with AccessibilityMatchers {
  private val request      = FakeRequest("GET", "/")
  private val messages     = app.injector.instanceOf[MessagesApi].preferred(request)
  private val pageTemplate = app.injector.instanceOf[HelloUniversePage]
